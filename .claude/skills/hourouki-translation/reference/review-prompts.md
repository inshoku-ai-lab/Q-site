...
**3人は英語圏の異なる地域の読者にする。** 読者はアメリカ人だけではなく、
世界中の英語話者だから（ユーザー方針）。

```
      ┌─ 査読者A：アメリカの読者 ────────┐
訳文 ─┼─ 査読者B：イギリス／連邦圏の読者 ─┼→ 2人以上が同じ箇所 → 【採用】
      └─ 査読者C：英語を母語としない       ┘   1人だけ         → 【保留リスト】
           流暢な読者（欧州・インド等）
```

この構成にすると、**方言の好みと本当の欠陥が自動的に分離できる**：

- **2人以上が一致** → 英語圏共通の問題。直す。
- **1人だけが指摘** → その地域の方言的好みである可能性が高い。保留。
  Ep 000 で `fit to burst` を「英国的だ」と言う査読者と「これが正しい」と言う査読者が
  対立して振動したが、混成パネルならこれは**対立ではなく分布として見える**。
- **地域特有の地雷は、その地域の査読者1人でも即採用**（下記の例外規定）。
  `minstrel`（黒塗り芸）も `laying pipe`（性的俗語）も `on a roll`（MDMA）も
  **米国読者にしか見えなかった**。英国の査読者だけが見える地雷も同様に存在する。

> 3人とも同じ地域にすると、その地域の方言的好みが「2人一致」として通ってしまい、
> 他の地域の読者にとって不自然な英語に寄っていく。**混成であることが精度を上げる。**
