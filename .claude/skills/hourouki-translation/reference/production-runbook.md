...
**バッチサイズ = 30話**（著者指示・2026-09-05 更新）。

当初は「他作業とぶつかるので6話で固定」という指示だったが、著者が他の作業を
別アカウントへ移し、このアカウントを翻訳に専念させる方針に変更。**30話ずつ**に引き上げた。

1バッチ = 30話 × 7工程 = **210エージェント**、およそ1,000万トークン。残り約17バッチ。
