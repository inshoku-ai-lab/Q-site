...
tags:
  ...
  - "争乱シナリオ"
images:
excerpt: "移行統合計画は、バイデン陣営による不正選挙で選挙を奪うことを想定してシナリオを作っていたように見える——ローザ・ブルックスはトランプによる暴動を予期、司法省は大量郵送システムの完全性確保に動き、SNSは選挙まで完全検閲され、バイデンが正々堂々と勝てない場合の争乱選挙シナリオを劇的に高める郵送投票が導入された。"
flags: "no-images"
---
