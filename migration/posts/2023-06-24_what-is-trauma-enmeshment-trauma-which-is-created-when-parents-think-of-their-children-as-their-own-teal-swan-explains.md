...
tags:
  ...
  - "家族関係"
images:
excerpt: "親が子供を「自分のもの」とみなして思い通りに成形しようとすると、子の真実を踏みにじり歪みを残す——それがエンメシュメント・トラウマ。腹が空いていない子の口にスプーンを押し込む母、医者になることを娘に強いる父、息子を夫の代わりにする妻——強度の差こそあれ全員が経験している家族の網に巻き込まれた傷を、ティール・スワンが具体例で解き明かす。"
flags: "no-images"
---
