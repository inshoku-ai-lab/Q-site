...
tags:
  ...
  - "評議会"
images:
excerpt: "ドミニオン社が参加する評議会が選挙設備情報共有・分析センター（EI-ISAC）を作った——クラウドストライク社はEI-ISACと連携しリソースを提供している。EI-ISAC会員でSLTT組織（州・地方・部族政府）であれば、無料でCIS安全セット会員にアクセスできる。米国に一〇〇〇件近く存在するSLTT組織を通じた選挙システム支配の構造。"
flags: "no-images"
---
