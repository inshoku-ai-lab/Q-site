...
tags:
  ...
  - "ハッキング"
images:
excerpt: "クラウドストライク社のサイバーセキュリティを下部組織に無料提供する構造——上層組織を支配すれば選挙システムを効率的に支配できる。ソーラーウィンズ社の侵入ツールハッキングは数多くの米国省庁、米国の核兵器備蓄を管理するエネルギー省（DOE）と国家核安全保障局（NNSA）にまで及んだ。トランプは中国の仕業、ポンペオはロシアと、見解が分かれた。"
flags: "no-images"
---
