...
tags:
  ...
  - "ロシア"
images:
excerpt: "マイクロソフト社、およびFBI・ODNI・NSAは、ソーラーウィンズ社ハッキングはロシアからのものだと結論——マイクロソフト社はロシアの攻撃者がソースコードの一部を侵害したと発表（二〇一九年一〇月から継続、ロシア系ノベリウム・ギャングによる攻撃）し、ソーラーウィンズ社は数々の助言書を発行して対応した。"
flags: "no-images"
---
