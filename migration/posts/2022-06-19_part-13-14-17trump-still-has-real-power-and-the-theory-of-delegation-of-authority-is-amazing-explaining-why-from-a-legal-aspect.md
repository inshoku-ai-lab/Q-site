...
tags:
  ...
  - "民間継続"
images:
excerpt: "連邦政府機能復興実行委員会のメンバーは、退任後も民間で権限委譲計画に関わる重要な仕事に就いている——トニー・オルナート氏はシークレットサービスのアシスタントディレクター、管理・予算局のラッセル・ヴォート氏は「アメリカ再生センター」を立ち上げトランプの政策とアジェンダを継続、国土安全保障省のチャド・ウルフ氏は小規模な国土安全保障省的活動を行う。"
flags: "no-images"
---
