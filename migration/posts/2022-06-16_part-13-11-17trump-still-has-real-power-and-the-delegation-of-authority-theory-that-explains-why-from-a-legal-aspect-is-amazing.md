...
tags:
  ...
  - "不正選挙"
images:
excerpt: "「破壊的インシデント」とは、重要な設備と政府の形態を維持する能力を妨げる動力学的・非動力学的攻撃や混乱に対する脆弱性——不正選挙で政府の形態を維持できなくなったとき、「復興戦略概要」の「私たちは、危機と政府の継続性に関連する既存の権限を最大限に活用しなければなりません」という言葉が、トランプが既存権限で敵を逃さなかったことを意味する。"
flags: "no-images"
---
