...
tags:
  ...
  - "デヴォリューション"
images:
excerpt: "二〇二二年一一月のトランプ氏「重要発言」がっかり会見の考察。デヴォリューション作戦進行中、Qは軍の覚醒作戦——という前提から導かれる結論は「白帽勢力が望んだ結果が世界に出てくる」。フォロワーの失望や「トランプに頼っては駄目」という意見こそが結果ならば、これはブラックピル（希望剥奪）でありパラサイトピル（依存解除）だ、と読み解く。"
flags: "no-images"
---
...
まだまだデボリューション作戦の途中なので、後数年はかかるだろうという予測です。
...
・デボリューション作戦が実行されているのは、有り余る証拠から判断して確実。
