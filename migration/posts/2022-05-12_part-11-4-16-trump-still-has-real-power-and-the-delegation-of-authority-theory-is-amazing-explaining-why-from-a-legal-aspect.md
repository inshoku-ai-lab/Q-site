...
tags:
  ...
  - "ロシアゲート"
images:
excerpt: "ミューラー報告書は、ロシアが民主党サーバーをハッキングし工作員会社がSNS工作を行ったとするが、引用情報には裏付けがなく時系列は論理に反する——ウィキリークスのアサンジ氏は「ロシアはハッキングの背後にいない」と主張、ミューラーはアサンジへのインタビューを拒否、ハッキング証拠の公開はクラウドストライク社が決めた、と矛盾を炙り出す。"
flags: "no-images"
---
