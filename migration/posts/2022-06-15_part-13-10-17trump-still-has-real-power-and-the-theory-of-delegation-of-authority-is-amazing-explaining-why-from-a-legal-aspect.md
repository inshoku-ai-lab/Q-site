...
tags:
  ...
  - "プロフェッショナル"
images:
excerpt: "復興戦略実行委員会のメンバーは権限委譲計画に深く関わるため、行動や立ち位置が怪しく見えても一概にブラックハットと決めつけられない——NSC主要委員会と復興実行委員会の両方に参加する四人全員が戦争・国家安全保障・情報の役割を担う。オブライエンの「とてもプロフェッショナルな政権移行をする」発言は権限委譲計画を示唆する。"
flags: "no-images"
---
