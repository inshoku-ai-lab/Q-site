...
tags:
  ...
  - "大統領令13961"
images:
excerpt: "大統領令一三九六一のセクション３で設置された連邦政府機能復興実行委員会が権限委譲計画の頭脳——責任と権限を持ち、継続計画の策定だけでなく実行を促進する。マーク・メドウズ氏は実行委員会に参加しないが計画で重要な役割を果たし、「The Chief's Chief」を著して、二〇二一年一月二〇日のトランプ退任スピーチで唯一彼を見送り、裏ルートとしての地位を確立した。"
flags: "no-images"
---
...
>
> (iv) 行政機関全体における連邦政府の復興戦略とNEFsに対するリスクを評価し、対処するための省庁間の枠組みを構築する。
