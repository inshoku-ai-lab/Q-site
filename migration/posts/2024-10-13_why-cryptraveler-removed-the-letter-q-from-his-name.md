...
tags:
  ...
  - "トランプ暗殺未遂"
images:
excerpt: "アカウントネームの「Qリプトラベラー」から「Q」を「ク」に戻し「クリプトラベラー」へ——Qは自身の存在を世間から隠したがっており、Qの目的（暗号通信の確立、J6を通じたデヴォリューション誘導）はJ6時点で半分以上終了したとの判断。さらにトランプ氏暗殺未遂事件の検証で、Q支持者の僕の名前にQがあるせいで確かな情報まで偽情報扱いされる懸念が決定打になった、と説明する記事。"
flags: "no-images"
---
...
クリプトラベラーの名前は２０１７年から使っていて、暗号通貨について呟いたりしてたんですが、２０１９年にQの軍事諜報作戦のことを知って以降、「ク」を「Q」と変更して、Qリプトラベラーとして Qに関する情報発信をするようになりました。
