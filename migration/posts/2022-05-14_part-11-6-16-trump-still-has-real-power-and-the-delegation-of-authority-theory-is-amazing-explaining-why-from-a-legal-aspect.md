...
tags:
  ...
  - "捏造"
images:
excerpt: "クラウドストライク社のショーン・ヘンリー氏は過去にミューラー氏の下でFBI副長官を務めていた——その後FBIは民主党サーバーの監査をクラウドストライク社だけに任せた。ウクライナの砲兵アプリをロシアがハックしたとの主張をウクライナが否定し、クラウドストライク社は後に撤回。物語を作るために証拠を捏造した可能性を解剖する。"
flags: "no-images"
---
